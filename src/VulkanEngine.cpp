...
void VulkanEngine::update_scene()
{
    ...
    sceneData.ambientColor = glm::vec4(0.2f, 0.2f, 0.2f, 1.f); // ”величили дл€ м€гкого освещени€

    // Sunlight color (main directional light)
    sceneData.sunlightColor = glm::vec4(1.f, 1.f, 1.f, 1.f); // Ѕелый свет
    float sunlightIntensity = 0.8f; // ”меньшаем €ркость света
